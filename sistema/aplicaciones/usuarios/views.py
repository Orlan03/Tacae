...
def registrar_empleado(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Crear el usuario usando create_user, que se encarga de hashear la contraseña
            user = User.objects.create_user(username=username, password=password)
            
            # Crear el objeto empleado (asumiendo que usas un modelo Empleado que tiene un campo OneToOneField hacia User)
